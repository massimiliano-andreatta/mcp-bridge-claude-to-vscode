...
suite("Execute Command Tool Test Suite", function () {
  ...
  suiteTeardown(async function () {
    ...
    await vscode.workspace.getConfiguration("mcpBridgeC2V").update("confirmNonDestructiveCommands", originalConfirmSetting, vscode.ConfigurationTarget.Global);
  ...
  suite("ModifySomething Flag Tests", function () {
    ...
    test("Non-destructive commands should skip confirmation when flag is false", async function () {
      ...
      await vscode.workspace.getConfiguration("mcpBridgeC2V").update("confirmNonDestructiveCommands", false, vscode.ConfigurationTarget.Global);
    ...
    test("Non-destructive commands should require confirmation when setting is enabled", async function () {
      ...
      await vscode.workspace.getConfiguration("mcpBridgeC2V").update("confirmNonDestructiveCommands", true, vscode.ConfigurationTarget.Global);
